...
import AIEmailWriter from "@/components/ai-email-writer"
...
export default function ComposeEmail({ open, onClose, onSend, replyTo }: ComposeEmailProps) {
  ...
  const handleInsertAIContent = (aiContent: string) => {
    ...
    const processedContent = aiContent
      .replace("[Your Name]", selectedAccount.name)
      .replace(
        "[your company/organization]",
        selectedAccount.name.includes("@") ? selectedAccount.email.split("@")[1] : "Company",
      )
      .replace("[Your Contact Information]", selectedAccount.email)

    // Set the content (preserving any existing content)
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={(open) => !open && onClose()}>
        <DialogContent className="sm:max-w-[700px] p-0 gap-0 max-h-[90vh] flex flex-col" hideCloseButton>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
                ...
                <div className="border-b p-1 flex items-center gap-1">
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>AI Email Writer</TooltipContent>
                    </Tooltip>
            ...
            <div className="p-4 border-t border-border flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <Button type="button" variant="outline" onClick={() => setAiWriterOpen(true)}>
